...
//        new ContextLoader(rootContext).initWebApplicationContext(servletContext);
        ...
        FilterRegistration.Dynamic xxxFilter = servletContext.addFilter(“xxx-filter", new XXXFilter()); 
        xxxFilter.setInitParameter("", ""); 
        xxxFilter.addMappingForUrlPatterns(null, true, “/xxxx/*”);		
```