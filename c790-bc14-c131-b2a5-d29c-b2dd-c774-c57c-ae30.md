...
```
```
Result "org.sample.SetAdd.addHashSet":
  79.923 ±(99.9%) 7.503 us/op [Average]
  (min, avg, max) = (78.111, 79.923, 82.769), stdev = 1.948
  CI (99.9%): [72.420, 87.426] (assumes normal distribution)


Result "org.sample.SetAdd.addLinkedHashSet":
  84.106 ±(99.9%) 10.006 us/op [Average]
  (min, avg, max) = (81.613, 84.106, 87.333), stdev = 2.599
  CI (99.9%): [74.100, 94.113] (assumes normal distribution)


Result "org.sample.SetAdd.addTreeSet":
  297.550 ±(99.9%) 56.801 us/op [Average]
  (min, avg, max) = (287.591, 297.550, 323.300), stdev = 14.751
  CI (99.9%): [240.749, 354.351] (assumes normal distribution)
