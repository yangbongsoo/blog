...
![](.gitbook/assets/mockitovsgroovy2.jpg)
...
`@DataJpaTest`는 1. Configure an in-memory database. 2. Auto-configure Hibernate, Spring Data and the DataSource. 3. Perform an `@EntityScan` 4. Turn on SQL logging
