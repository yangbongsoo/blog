...
클래스, 속성, 관계 식별(정적 모델링) => 요구사항 명세 식별
도메인 모델에 행위 추가하기. 
요구사항 식별하기 -> 요구사항은 2가지 부분으로 구성된다. (사용자 행위 / 사용자 행위 요청에 대한 애플리케이션의 응답)
메서드 식별하기
TDD로 메서드 구현하기
